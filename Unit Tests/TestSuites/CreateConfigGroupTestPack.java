 ...
 * @author fnell
 */
public class CreateConfigGroupTestPack{
    static TestMarshall instance; 
    
     public CreateConfigGroupTestPack()
    {
    ...
    {
        System.out.println("Mix Telematics Test Pack");   
        instance = new TestMarshall("TestPacks\\CreateConfigGroupTestPack.xlsx", Enums.BrowserType.Chrome);
        instance.runKeywordDrivenTests();
    }
