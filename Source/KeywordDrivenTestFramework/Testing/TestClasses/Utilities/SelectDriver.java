 ...
 * @author elebese
 */
public class SelectDriver extends BaseClass
{
    int counter = 1;
    ...
    public SelectDriver(TestEntity testData) 
    {
    ...
    public boolean selectOrganisationGroup() 
    {
        ...
        if (!SeleniumDriverInstance.waitForElementByXpath(UtilitiesPageObject.HeadingSelectDriverXpath(), 30)) 
        {
