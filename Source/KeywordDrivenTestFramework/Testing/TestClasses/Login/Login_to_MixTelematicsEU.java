 ...
 * @author fnell
 */
public class Login_to_MixTelematicsEU extends BaseClass 
{
    ...
    public Login_to_MixTelematicsEU(TestEntity testData) 
    {
        this.testData = testData;

    }
    
    public Login_to_MixTelematicsEU() { }
    ...
    public boolean NavigatetoMixTelematics() 
    {
        ...
        if (!SeleniumDriverInstance.navigateTo("https://eu.mixtelematics.com")) 
        {
