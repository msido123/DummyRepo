...
public class GenerateID {
    ...
    private String type = ""; //Type of ID that needs to be generated
    ...
    public GenerateID(String dateOfBirth, String gender, String type)
    {
    ...
    public String getID() {
        ...
        if (dateOfBirth.equalsIgnoreCase("Leapyear"))
        {
            dateOfBirth = "960229";
        }
        else if (dateOfBirth.equalsIgnoreCase("Passport"))
        {
            dateOfBirth = "L01B/0";
        }
        ...
        {
            // IDP11
            IDP11 = Integer.toString(getRandBetween(0, 9));

            // IDP12
            IDP12 = Integer.toString(getRandBetween(0, 9));
    ...
    private String getGenderNumber() {
        ...
        if (gender.contains("Male")) 
        {
            ...
            {
                genderNumber = getRandBetween(99, 50);
            }
            else if(type.equalsIgnoreCase("BOT"))
            {
                genderNumber = getRandBetween(9, 5);
            }
        } 
        else 
        {
            ...
            if(type.equalsIgnoreCase("NAM"))
            {
                genderNumber = getRandBetween(49, 1);
            }
            else if(type.equalsIgnoreCase("BOT"))
            {
                genderNumber = getRandBetween(4, 1);
            }
        }
        ...
        String genderStr = Integer.toString(genderNumber);
            ...
            {
                //Do nothing - Only want to return one digit
            }
            else
            {
                if (genderStr.length() == 1) {
