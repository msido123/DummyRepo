...
public class OtpSmsUtility extends BaseClass {
    ...
    public boolean waitForCloseImage() {
        if (!SeleniumDriverInstance.waitForElementByClassName(closeBtnClass)) {
            return false;
        }
        return true;
    }
    ...
    public boolean clickClose() {
        if (!SeleniumDriverInstance.clickElementbyClassName(closeBtnClass)) {
            return false;
        }
        return true;
    }
    ...
    public boolean waitForSignInHead() {
        if (!SeleniumDriverInstance.waitForElementByClassName(airdroidHeadClass)) {
            return false;
        }
        return true;
    }
    ...
    public boolean enterAccount() {
        ...
        if (!SeleniumDriverInstance.enterTextByClassName(accountTextBoxClass, this.username)) {
    ...
    public boolean enterPassword() {
        if (!SeleniumDriverInstance.enterTextByClassName(passwordTextBoxClass, this.password)) {
            return false;
        }
        return true;
    }
    ...
    public boolean clickSignIn() {
        if (!SikuliDriverInstance.MouseClickElement(submitButtonImagePath)) {
            return false;
        }
        return true;
    }
    ...
    public boolean clickMessages() {
        if (!SikuliDriverInstance.MouseClickElement(messagesButtonImagePath)) {
            return false;
        }
        return true;
    }
