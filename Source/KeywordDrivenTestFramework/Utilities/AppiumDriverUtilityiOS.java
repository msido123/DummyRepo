 ...
 * @author drousseau
 */
public class AppiumDriverUtilityiOS extends BaseClass
{
...
//    public RemoteWebDriver Driver;
    ...
    public AppiumDriverUtilityiOS(String a) throws MalformedURLException, IOException, InterruptedException
    {
        String pack,act;
//        try
//        {
...
//        start();
	...
	capabilities.setCapability("platformName","iOS"); 
        capabilities.setCapability("bundleId", pack);
    ...
    public AppiumDriverUtilityiOS()
    {
        ...
        else
        {
            ...
            Driver = (IOSDriver) setCapabilitiesRemoteRun(currentDevice.DeviceID, currentDevice.ServerURL);
            _isDriverRunning = true;
...
//          capabilities.setCapability("appActivity", currentDeviceConfig.appActivity);
    ...
    public void selectPlatform()
    {
        ...
        {
            case Android:
                Driver = (IOSDriver) setCapabilitiesWithApk();
                _isDriverRunning = true;
                break;
            case iOS:
