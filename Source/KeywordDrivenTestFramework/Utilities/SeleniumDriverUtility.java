...
public class SeleniumDriverUtility extends BaseClass {
    ...
    public Boolean _isDriverRunning;
...
//                  Driver = new InternetExplorerDriver();
            ...
            case Canary:
                ...
                options2.setBinary("C:\\Users\\RauvounW\\AppData\\Local\\Google\\Chrome SxS\\Application\\chrome.exe");
                options2.setExperimentalOption("excludeSwitches", Arrays.asList("enable-automation"));
  ...
  public String retrieveSelectedText(String elementXpath) {
   ...
   public String retrieveTooltipByXpath(String elementXpath) {
        ...
        try {
            ...
            Thread.sleep(3000);
            retrievedText = elementToRead.getAttribute("title");
            System.out.println("[Info]Text retrieved successfully from element - " + elementXpath);
            return retrievedText;
  } catch (Exception e) {
            System.err.println("[Error] Failed to retrieve text from element Xpath - " + e.getMessage());
   ...
   public int getElementHeight(String elementXpath) {
    ...
    public boolean clickElementbyXpath(String elementXpath) {
        try {
            ...
            System.out.println("[Info]Element clicked sucessfully.");
            return true;
        } catch (Exception e) {
    ...
    public boolean clickElementOffSetByXpathUsingActions(String elementXpath, int x, int y)
    {
        try 
        {
            System.out.println("[INFO] Clicking element by Xpath : " + elementXpath);
            ...
            WebElement elementToClick = Driver.findElement(By.xpath(elementXpath));
            Actions builder = new Actions(Driver);
            builder.moveToElement(elementToClick).moveByOffset(x, y);
            builder.click();
            builder.perform();
...
//                        }
    ...
    public String getElementTextByXpath(String elementXpath) {
        ...
        {
            String retrievedText;
            this.waitForElementByXpath(elementXpath,30);
...
//                            System.err.println("[Error] Failed to wait for element by name  - " + ex.getMessage());
    ...
    public String retrieveElementAttributeByXpath(String elementXpath, String attributeName) 
    {
       String propertyValue = "";
        try 
        {
            this.waitForElementByXpath(elementXpath, 10);
...
//    }
      ...
      public String retrieveAssetRowNumberByXpath(String elementXpath) {
        String retrievedText = "";
        try {
            this.waitForElementByXpath(elementXpath);
            WebElement elementToRead = Driver.findElement(By.xpath(elementXpath));
            retrievedText = elementToRead.getAttribute("row");
            System.out.println("[Info]Text retrieved successfully from element - " + elementXpath);
            return retrievedText;
    ...
    public boolean waitForElementByXpathVisibility(String elementXpath) {
        ...
        public boolean waitForElementByXpathClickable(String elementXpath) {
        boolean elementFound = true;
        try 
        {
            int waitCount = 0;
   ...
   public void takeScreenShot(String screenShotDescription, boolean isError)
    {
        ...
        try
        {
            ...
            File f;
            FileUtils.copyFile(screenShot, f=new File(imageFilePathString.toString()));
            if(imageFilePathString.contains("F_"))
            {
                File temp = new File("ASD");
                String dir=temp.getAbsolutePath().substring(0,temp.getAbsolutePath().length()-2);
                System.out.println(dir);
                File s=new File("FailedStep.png");
                File s1;
                FileUtils.copyFile(f, s1=new File(dir));
                s1.renameTo(s);
            }
            if(!isError)
            {
...
//                    action.perform();
    ...
    public boolean validateSelectedRadioButtonUsingXpath(String radioButtonXpath) {
        ...
        try {
            WebElement radioButton = Driver.findElement(By.xpath(radioButtonXpath));
               ...
               yesORno = radioButton.isSelected();
            } catch (Exception ex) {
            System.err.println("[ERROR] failed to find element: " + ex.getMessage());
            return false;
        }
    ...
    public boolean UploadFileUsingXpath(String xpath, String FilePath)
    {
        try
        {
            waitForElementByXpath(xpath,30);
            System.out.println("[INFO] Waiting For Element by Xpath : "+xpath);
            System.out.println("[INFO] File Path : "+FilePath);
            
            WebElement uploadButton = Driver.findElement(By.xpath(xpath));
            uploadButton.sendKeys(FilePath);
        }
        catch (Exception e)
        {
            narrator.logError("Failed to Upload file, error - " + e.getMessage());
...
//            return false;
    ...
    public boolean scrollToElementById(String elementid)
    {
        try {
            WebElement element = Driver.findElement(By.id(elementid));
            ((JavascriptExecutor) Driver).executeScript("arguments[0].scrollIntoView(true);", element);
        ...
        {
            System.err.println("Error scrolling to element - " + elementid + " - " + e.getStackTrace());
            this.DriverExceptionDetail = e.getMessage();
            return false;
        }
        
    }
        public boolean scrollToElementException(String elementXpath)
    {
        try {
            WebElement element = Driver.findElement(By.xpath(elementXpath));
            ((JavascriptExecutor) Driver).executeScript("arguments[0].scrollIntoView(true);", element);
    ...
    public boolean EnterTextInAtextBox( String elementXpath, String textToEnter1, String textToEnter2)
    {
        ...
        {
            System.err.println("Error entering text into a text box - " + elementXpath + " - " + e.getStackTrace());
            this.DriverExceptionDetail = e.getMessage();
            return false;
        }
     ...
     public List<String> getAssetsListOnGrid(String elementXpath, String _numberOfPages,String nextPageXpath) {
         ...
         try {
            int pages = 1;int numberOfPages =1;
            List<String> reportData = new ArrayList<String>();
                    ...
                    //iterate through rows.
                     List<WebElement> rows = _divColumns.findElements(By.className("cell"));
                        for (int i = 0; i < rows.size(); i++) {
                            ...
                            String timeZone ="";String newDate ="";
     ...
     public List<String> getDriversListOnGrid(String elementXpath, String _numberOfPages,String nextPageXpath) {
         List<String> gridData = new ArrayList<String>();
         List<String> gridDataWithHeaders = new ArrayList<String>();
         try {
            int pages = 1;int numberOfPages =1;
            List<String> reportData = new ArrayList<String>();
            String columHeaders = "";
           ...
           gridDataWithHeaders.add(columHeaders);gridDataWithHeaders.addAll(gridData);
...
//            }
            ...
            while(pages <= numberOfPages){
                this.takeScreenShot("AssetListPage"+pages, false);
                reportData = new ArrayList<String>();
                waitForElementByXpath(elementXpath,5000);
    ...
    //                        }
     ...
     public boolean selectByTextFromDropDownListusingXpathNoException(String elementXpath, String valueToSelect) {
        try {
            waitForElementByXpath(elementXpath);
            Select dropDownList = new Select(Driver.findElement(By.xpath(elementXpath)));
     ...
     public boolean returnToPreviousTab(String previousTab) 
   {
    ...
    public boolean CheckIfElementDisplayedByXpathException(String elementXpath) {
        try {
            waitForElementByXpath(elementXpath, 10);
            WebElement element = Driver.findElement(By.xpath(elementXpath));
    ...
    public boolean waitForElementToBeClickableByXpathTimeout(String elementXpath, Integer timeout)
    {
        boolean elementFound = false;
        try
        {
     ...
     public String generateDateTimeStampValue()
    {
     ...
     public void getCoordinatesOfWebElementByXpath(String elementXpath)
     {
        WebElement element = Driver.findElement(By.xpath(elementXpath));
        String location = String.valueOf(element.getLocation());
    ...
    public String getElementEnabledStatusByXpath(String elementXpath) 
    {
        ...
        try{
            ...
            isEnabled = elementToClick.getAttribute("disabled");
    ...
    public boolean DragElementByXpathWithOffset(String sourceElementXpath, int x, int y) {
        try {
            System.out.println("[Info]Performing drag and drop for element - " + sourceElementXpath);
            
            WebElement sourceElement = SeleniumDriverInstance.Driver.findElement(By.xpath(sourceElementXpath));
            Actions builder = new Actions(SeleniumDriverInstance.Driver);   
            builder.moveToElement(sourceElement).clickAndHold().build().perform();
            SeleniumDriverInstance.pause(100);
    ...
    //YDUma
    public boolean DragAndDropElementByRobotAndOffsetByXpath(String sourceElementXpath, int xOffSet, int yOffSet) {
        try {
...
//            builder.perform();
    ...
    //NMei
    public boolean DragAndDropElementByRobotAndOffset(int xStart,int yStart,int xEnd,int yEnd)
    {
        try 
        {
            Robot robot = new Robot(); 
    ...
    {
         try {
             waitForElementByXpath(elementXpath, 15);
             WebElement mainDiv = Driver.findElement(By.xpath(elementXpath));
...
//YDUMA return text list within a span
public List<String> retrieveListOfSpanElements(String elementXpath) 
    {
         try {
             Thread.sleep(5000);
...
public List<String> retrieveListOfElementsFromAColumn(String elementXpath) 
    {
         try {
             this.waitForElementByXpath(elementXpath);
             ...
             List<String> reportData = new ArrayList<String>();
             WebElement element1 = Driver.findElement(By.xpath(elementXpath));
             List<WebElement> divRows = element1.findElements(By.xpath(elementXpath));
...
public boolean ClickListOfElementsWithExpander(String elementXpath) 
    {
     ...
     public String extractAssetDetailsAndDeselectOrSelectFromOrganisationGroupByXpath(String elementXpath, String assestToSelect) {
        String extractedSite = ""; String unSelected ="Deselected Assets: ";
            String toSelectAssets ="Selected Assets: ";String alreadySelected ="Default Selected: ";
        try {
    ...
    public boolean messageAllColumnChooserSelect(String elementXpath, String columnToSelectXpath) {
        try {
            ...
            elementToClick.click();
            SeleniumDriverInstance.pause(1000);
            waitForElementByXpath(columnToSelectXpath, 5);
...
//             Thread.sleep(5000);
    ...
    public String getADatesFormart()
         ...
         try
         {
            ...
            System.out.println("tomorrow is: " + dateFormat.format(tomorrow).toString());
...
//             WebElement element1 = Driver.findElement(By.xpath(elementXpath));
    ...
    public List<String> retrieveListOfElementsOnColumn1(String elementXpath, String tagName) 
    {
         try {
             Thread.sleep(5000);
...
//             WebElement element1 = Driver.findElement(By.xpath(elementXpath));
    ...
    public boolean drawUsingOffset(int x, int y, int xToDragTo, int yToDragTo) 
    {
        try 
        {
            Robot robot = new Robot(); 
            robot.mouseMove(x, y);
            robot.mousePress(InputEvent.BUTTON1_MASK);
            robot.mouseMove(xToDragTo, yToDragTo);
            Thread.sleep(500);
            robot.mouseRelease(InputEvent.BUTTON1_MASK);
            ...
            System.err.println("[Error] Failed to draw location - " + e.getMessage());
            this.DriverExceptionDetail = e.getMessage();
            return false;
        }
    }
...
//            Thread.sleep(8000);
    ...
    public boolean unCheckColumnChooserList(String elementXPath) {
        try {
            waitForElementByXpath(elementXPath);
                    ...
                    //iterate through rows.
                     List<WebElement> rows = _divColumns.findElements(By.className("cell"));
                        for (int i = 0; i < rows.size(); i++) {
                            ...
                            if(!rows.get(i).getText().equals("")){
                            String dateSub = rows.get(i).getText().substring(0,10);
                            String timeSub = rows.get(i).getText().substring(11,16);
                            timeZone = rows.get(i).getText().substring(16).trim();
                            String[] dateSlipted = dateSub.split("-");
                            newDate = dateSlipted[2]+"-"+ this.getMonthAbr(Integer.parseInt(dateSlipted[1]))+"-"+dateSlipted[0];
                            }
                            if (empty == false) {
...
//            moveTo.perform();
    ...
    public boolean isCheckBoxSelected(String elementXPath)
    {
        ...
        boolean c = isSelected.isSelected();
...
//            action.moveToElement(div, centerX, centerY).click().build().perform();
    ...
    //YDuma
    public String SwitchToNewWindow2()
    {
        // get the current window handle
        System.out.println("Switching to new window");
         String parentHandle = SeleniumDriverInstance.Driver.getWindowHandle(); 
     ...
     public void SwitchToOriginalWindow(String parentHandle)
    {
     ...
     //YDuma
     public void SwitchBackToOriginalWindow(String parentHandle)
    {        
        SeleniumDriverInstance.Driver.close(); // close newly opened window when done with it
        SeleniumDriverInstance.Driver.switchTo().window(parentHandle); // switch back to the original window
        pause(3500);
...
//           Boolean isSet = capabilities.isJavascriptEnabled();
    ...
    public boolean HoverOverElementByXpathOffset(String elementXpath, int x, int y) {
       ...
       WebElement elementToRead = Driver.findElement(By.xpath(elementXpath));
            Point coordinates = elementToRead.getLocation();
            Robot robot = new Robot(); 
            robot.mouseMove(coordinates.getX() + x, coordinates.getY() + y); //Number 65 should vary
//            robot.mousePress(InputEvent.BUTTON1_MASK);
//            robot.mouseRelease(InputEvent.BUTTON1_MASK);
            Thread.sleep(1000);
    ...
    //Yduma
    public boolean moveToElementByXpathRobot2(String elementXpath) {
        ...
        try {
            ...
            Point coordinates = elementToRead.getLocation();
            Robot robot = new Robot(); 
            robot.mouseMove(coordinates.getX()+15, coordinates.getY() + 75); //Number 65 should vary
...
//            Thread.sleep(2000);
    ...
    public boolean drop(String elementXpath, String Asset) 
    {
        try 
        {
            this.waitForElementByXpath(elementXpath, 60);
            ...
            System.err.println("[Error] row number where a status is found inside a dropdown - " + e.getMessage());
            this.DriverExceptionDetail = e.getMessage();
...
//            Thread.sleep(8000);
    ...
    public String generatePhoneNumber()
    {
        try{
           ...
           phoneNum = SeleniumDriverInstance.generateDateTimeString("MM-dd_HH-mm-ss");
           phoneNum = phoneNum.replace('-', ' ').replace('_', ' ').substring(1);

           return phoneNum;
       } catch (Exception e) {
            System.err.println("[Error] Failed to generate phone number - " + e.getMessage());
            return null;
        }
    }
    //Siwaphiwe Mbiko
    ...
    //Sakhumzi Ncantswa
    public void refreshWebWindow() 
    {
      Driver.navigate().refresh();
    }
    
    //Sakhumzi Ncantswa
    public String extractTableElement(String Tablexpath)
    {
        WebElement Cell = Driver.findElement(By.xpath(Tablexpath));
        String parameter = Cell.getText().trim();
                    
        return parameter;
    }
    
    //Sakhumzi Ncantswa
    public boolean ValidateExcelTableHeaders(String ExcelFileName,String ExcelSheetName,String [] ColumnHeaders) 
    {
        ...
        LinkedList<DataRow> sourceDataCells = excelReader.retrieveDataRowsFromSheet(downloadPath+"\\"+ExcelFileName,ExcelSheetName);
        // List<DataRow> sourceDataCells = excelReader.getSourceDataFromExcelFile("Sample Data\\TestData\\RIDetails.xlsx");
        List<DataRow> htmlDataList = new ArrayList<>();
        int row_num = 1, col_num = 0;

        //<editor-fold defaultstate="collapsed" desc="----------HTML Table Data----------">
        System.out.println("----------Excel Table Header Data----------");
        ...
        try
            {
              ...
              for (int i = 0; i < ColumnHeaders.length; i++) 
                {
                  currentRow.DataColumns.add(new DataColumn("Column_" + i + "Row_0", ColumnHeaders[i]));
                }
            }
        catch(Exception e)
            {
               // globalErrorMessage = "Failed to retrieve all the column headings";
                 System.out.println("[Error] " + e.getMessage());
                 return false;
            }
            htmlDataList.add(currentRow);
                //System.out.println("Column_" + i + "Row_" + j + "text= " + htmlDataList);
        ...
        //<editor-fold defaultstate="collapsed" desc="----------Compare Data from the Excel File to data from the System Tables----------">
            
            System.out.println("----------Compare Data from the Excel File----------");
            
            
            for (row_num = 0; row_num < htmlDataList.size(); row_num++) 
            {
                DataRow KNOWNDATA = htmlDataList.get(row_num);
                DataRow EXCELDATA = sourceDataCells.get(row_num);
                String EXCELcellData = "";
                String KnowncellData = "";
                
                for (col_num = 0; col_num < KNOWNDATA.DataColumns.size(); col_num++) 
                {
                    if(row_num == 0){
                        EXCELcellData = EXCELDATA.DataColumns.get(col_num).columnHeader;
                        KnowncellData = KNOWNDATA.DataColumns.get(col_num).columnValue;
                    }else
                    {
                        EXCELcellData = EXCELDATA.DataColumns.get(col_num).columnValue;
                        KnowncellData = KNOWNDATA.DataColumns.get(col_num).columnValue;
                    }                                        
                    
                    if(EXCELcellData.equals(KnowncellData))
                    {
                        if(EXCELcellData.equals("") && KnowncellData.equalsIgnoreCase(""))
                        {
                          System.out.println("Compared Items in Column_" + col_num + " Row_ " + row_num + " SUCCESSFULLY - NULL values" ); 
                        }
                        else
                        {
                            System.out.println("Compared Items in Column_" + col_num + " Row_ " + row_num + " SUCCESSFULLY - " +  EXCELcellData+" and "+ KnowncellData );
                        }
                    ...
                    {
                        if(EXCELcellData.equals("") && !KnowncellData.equals(""))
                        {
                          System.err.println("Failed to Compare Items in Column_" + col_num + " Row_ " + row_num + " - NULL and "+ KnowncellData );
                        }
                        else if (!EXCELcellData.equals("") && KnowncellData.equalsIgnoreCase(""))
                        {
                          System.err.println("Failed to Compare Items in Column_" + col_num + " Row_ " + row_num + " - " +  EXCELcellData+" and NULL");  
                        }
                        else
                        {
                          System.err.println("Failed to Compare Items in Column_" + col_num + " Row_ " + row_num + " - " +  EXCELcellData+" and "+ KnowncellData );
                        }
        ...
        return true;
            ...
            System.err.println("Error validating Excel Table Header" + e.getMessage());
            this.DriverExceptionDetail = "Error validating Excel Table Header";
            return false;
                }
    }
    
     //Sakhumzi Ncantswa
    public boolean ValidateExcelTableContent(String ExcelFileName,String ExcelSheetName,String DivXpath) 
    {
        ...
        LinkedList<DataRow> sourceDataCells = excelReader.retrieveDataRowsFromSheet(downloadPath+"\\"+ExcelFileName,ExcelSheetName);
        List<DataRow> htmlDataList = new ArrayList<>();
        WebElement table_element = Driver.findElement(By.xpath(DivXpath));
        ...
        try
            {
               ...
               for (int k = 0; k < tr_collection.size(); k++) 
                 {
                   //ctl00_cntMainBody_ReInsurance2007Cntrl_gvReinsurance
                   List<WebElement> td_collection = tr_collection.get(k).findElements(By.tagName("td"));
                   DataRow currentRow0 = new DataRow();
                 
                   if(!td_collection.isEmpty())
                    {
                      for (int v = 0; v < (td_collection.size()-1); v++) 
                       {
                          //CellXpath = "//table[@class='RITable']/tbody//tr[" + (j+1) + "]//th[" + (i+1) + "]";
                          CellXpath = "//table[@class='table table-scroll table-condensed table-list no-text-clip']/tbody/tr["+(k+1)+"]/td[" + (v+2) + "]/div//span";
                          WebElement Cell = Driver.findElement(By.xpath(CellXpath));
                          String parameters = Cell.getText().trim();
                    
                         // tableHeadingColumns.put("Column_" + i + "Row_" + (j+1), parameter);
                          currentRow0.DataColumns.add(new DataColumn("Column_" + v + "Row_" + k, parameters));
                          System.out.println("Column_" + v + "Row_" + k + "text= " + parameters);
                      }
                    htmlDataList.add(currentRow0);
                }
            }
            }
        catch(Exception e)
        ...
        //<editor-fold defaultstate="collapsed" desc="----------Compare Data from the Excel File to data from the System Tables----------">
            ...
            for (row_num = 0; row_num < htmlDataList.size(); row_num++) 
            {
                DataRow HTMLDATA = htmlDataList.get(row_num);
                ///We add one so that the first row with headers doesnt get loaded
                DataRow EXCELDATA = sourceDataCells.get((row_num));
                String EXCELcellData = "";
                String HTMLCELLDATA = "";
                
                for (col_num = 0; col_num < HTMLDATA.DataColumns.size(); col_num++) 
                {
                    EXCELcellData = EXCELDATA.DataColumns.get(col_num).columnValue;
                    HTMLCELLDATA = HTMLDATA.DataColumns.get(col_num).columnValue;
                    
                    EXCELcellData = EXCELcellData.trim();
                    HTMLCELLDATA = HTMLCELLDATA.trim();
                    
                    if(EXCELcellData.equals(HTMLCELLDATA))
                    {
                        if(EXCELcellData.equals("") && HTMLCELLDATA.equalsIgnoreCase(""))
                        {
                          System.out.println("Compared Items in Column_" + col_num + " Row_ " + (row_num+1)+ " SUCCESSFULLY - NULL values" ); 
                        }
                        else
                        {
                            System.out.println("Compared Items in Column_" + col_num + " Row_ " + (row_num+1) + " SUCCESSFULLY - " +  EXCELcellData+" and "+ HTMLCELLDATA );
                        }
                    ...
                    {
                        if(EXCELcellData.equals("") && !HTMLCELLDATA.equals(""))
                        {
                          System.err.println("Failed to Compare Items in Column_" + col_num + " Row_ " + (row_num+1) + " - NULL and "+ HTMLCELLDATA );
                        }
                        else if (!EXCELcellData.equals("") && HTMLCELLDATA.equalsIgnoreCase(""))
                        {
                          System.err.println("Failed to Compare Items in Column_" + col_num + " Row_ " + (row_num+1) + " - " +  EXCELcellData+" and NULL");  
                        }
                        else
                        {
                          System.err.println("Failed to Compare Items in Column_" + col_num + " Row_ " + (row_num+1)+ " - " +  EXCELcellData+" and "+ HTMLCELLDATA );
                        }
        ...
        return true;
            ...
            System.err.println("Error validating Excel Table Header" + e);
            this.DriverExceptionDetail = "Error validating Excel Table Header";
            return false;
                }
    }
    ...
    //Sakhumzi Ncantswa
    public FirefoxProfile downloadprofile()
    {
         FirefoxProfile profile = new FirefoxProfile();
        
        profile.setPreference("browser.download.panel.shown", true);
        profile.setPreference("browser.download.manager.showWhenStarting", false);
        profile.setPreference("browser.helperApps.neverAsk.openFile","text/csv,application/vnd.ms-excel,application/pdf");
        profile.setPreference("browser.helperApps.neverAsk.saveToDisk", "application/zip, application/xls, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, text/csv, text/xml, application/octet-stream");
        profile.setPreference("browser.download.folderList", 2);    
        profile.setPreference("browser.download.dir", "C:/Users/" + System.getProperty("user.name") + "/Downloads/");
    ...
    //Sakhumzi Ncantswa
    public boolean verifyTextInElementListTextById(String elementID, List<String> textToCompare) {
        try {
            waitForElementById(elementID);
            Select comboBox = new Select(Driver.findElement(By.id(elementID)));
            List<WebElement> el = comboBox.getOptions();

            if (!el.isEmpty()) {
                for (int i = 0; i < textToCompare.size(); i++) {
                    String k = el.get(i + 1).getText();
                    if (k.equals(textToCompare.get(i))) {
                        System.out.println("Compared " + k + " to " + textToCompare.get(i) + " successfully");
                    } else {
                        System.err.println("Error - Failed to compare " + k + " to " + textToCompare.get(i));
                        return false;
                    }
                }
            } else {
                System.err.println("Error - Failed to get the list for comparing ");
                return false;
            }
            return true;
        } catch (Exception e) {
            System.err.println("Error - amount is not correct " + elementID);
            return false;
        }
    }

    //Sakhumzi Ncantswa
    public boolean verifyTextInElementListTextByXpath(String elementXpath, List<String> textToCompare) {
        try {
            this.waitForElementByXpath(elementXpath);
            Select comboBox = new Select(Driver.findElement(By.xpath(elementXpath)));
            List<WebElement> el = comboBox.getOptions();
            ...
            System.err.println("Error - amount is not correct " + elementXpath);
            return false;
        }
    }

    //Sakhumzi Ncantswa
    public boolean getTextInElementListTextByXpath(String elementXpath) {
        try {
            this.waitForElementByXpath(elementXpath);
            Select comboBox = new Select(Driver.findElement(By.xpath(elementXpath)));
            List<WebElement> el = comboBox.getOptions();
    ...
    //Shannon Scholtz
    public List<String> retrieveListOfElementsUSingAAndSpan(String elementXpath) 
    {
        List<String> reportData = new ArrayList<String>();
         try {
             this.pause(5000);
            
             List<WebElement> columns = Driver.findElements(By.xpath(elementXpath));
//             List<WebElement> spans = columns.get(1).findElements(By.tagName(".//span[2]"));
             
             for (WebElement _divData : columns) 
             {
                 reportData.add(_divData.getAttribute("innerHTML"));
             }
    ...
    //Luvo Mgulwa
    public boolean deselectColumnChooserList(String elementXPath) {
        try {
            waitForElementByXpath(elementXPath);
    ...
    //Sakhumzi Ncantswa
    public boolean clearTextUsingActionsByXpath(String elementXpath) 
    {
        try 
        {
            this.waitForElementByXpath(elementXpath);
    ...
    public boolean selectByIndexFromDropDownListUsingXpath(String elementXpath, Integer indexToSelect) {
        try {
            ...
            System.err.println("[Error]Failed to select option from dropdownlist by index using Xpath - " + e.getMessage());
            this.DriverExceptionDetail = e.getMessage();
            return false;
        }
    }
    ...
    //Luvo Mgulwa
    public boolean isColumnChooserSelected(String elementXPath) {
        try {
            waitForElementByXpath(elementXPath);
            ...
            System.err.println("[Error] Failed to find element by Xpath - " + e.getMessage());
            this.DriverExceptionDetail = e.getMessage();
            return false;
        }
    }
    ...
    //Luvo Mgulwa
    public String hoverOverElementAndRetrieveText(String elementXpath, String Tooltip) {
        try {
            this.waitForElementByXpath(elementXpath);
            String retrievedText;
            ...
            takeScreenShot("Successfully hovered over and retrieved '" + retrievedText + "'", false);
            js.executeScript("$(arguments[0]).mouseout();", elementToClick);     
    ...
    //Shannon Scholtz
    public boolean MoveElementOffSetByXpathUsingActions(String elementXpath, int x, int y)
    {
        try 
        {
            System.out.println("[INFO] Clicking element by Xpath : " + elementXpath);
    ...
    //Sakhumzi Ncantswa
    public boolean validateLogViewerDate(Date DateTime1,Date DateTime2,TestEntity testData,String Movement,String timezoom)
    {
        
        try
        {
          WebElement table_element = Driver.findElement(By.xpath("//div[@class='fleet-grid full-height has-row-actions']/table/tbody"));
          List<WebElement> tr_collection = table_element.findElements(By.tagName("tr"));
          String date1="";
          for(int i = 1; i < tr_collection.size(); i++)
          {
              
              String CellXpath = "//div[@class='fleet-grid full-height has-row-actions']/table/tbody/tr["+(i+1)+"]/td[3]/div/span";
              WebElement Cell = Driver.findElement(By.xpath(CellXpath));
              String parameters = Cell.getText().trim();
          
             if(!parameters.equals(""))
              {
                 String [] k = parameters.split(" ");
         
                 date1 = k[0]+" "+k[1]+" "+k[2];//date
                 
                 DateFormat  dtf = new SimpleDateFormat("yyyy-MM-dd hh:mm a",Locale.ENGLISH);
         
                 Date DateTime0 = dtf.parse(date1);
                 
                Long time = DateTime0.getTime();
                 //if((DateTime0.a.getTime() >= DateTime1.getTime() ) && (DateTime0.getTime() <= DateTime2.getTime()))
                 if(DateTime0.after(DateTime1)&& DateTime0.before(DateTime2))
                 {
                     System.out.println("Date Pass  : "+DateTime0.toString()+" is between"+DateTime1+" and "+DateTime2);
                     testData.extractParameter("Log viewer DateTime For "+timezoom+i,DateTime0.toString()+" fits between "+DateTime1.toString()+" and "+ DateTime2.toString() , "Pass");
                 }
                 else
                 {
                     System.err.println("Fail Date : "+DateTime0.toString()+" is not between"+DateTime1+" and "+DateTime2);
                     testData.extractParameter("Log viewer DateTime for"+timezoom+i,DateTime0.toString()+" does not fit between"+DateTime1.toString()+" and "+DateTime2.toString() , "Fail");
                     return false;
                 }
              }
            ...
            System.err.println("Error moving to element -  " + e.getStackTrace());
            this.DriverExceptionDetail = e.getMessage();
        }
    ...
    //Mnisi Sibusiso 
      public boolean HoverOverElementByXpathRobot(String elementXpath, int x, int y) {
      ...
      //YDuma
      public boolean ClickOverElementByXpathRobot(String elementXpath, int x, int y) {
...
//            robot.mouseMove(x,y); 
      ...
      //YDuma
      public boolean ClickElementByXpathRobot(String elementXpath, int x, int y) {
    ...
    //Sakhumzi Ncantswa
    public void scrollMouseWheelRobotClass(){
        try{
             Robot robot = new Robot();
    ...
    //Andisiwe Peter
    public boolean MouseDragElementByXpathOffset(String elementXpath, int x,int numberToAddToXCoodinate, int y, int numberToAddToYCoodinate) {    
        try {
            this.waitForElementByXpath(elementXpath);
            ...
            Robot robot = new Robot(); 
            robot.mouseMove(coordinates.getX() + numberToAddToXCoodinate,coordinates.getY() + numberToAddToYCoodinate);
            this.pause(1500);
            robot.mousePress(InputEvent.BUTTON1_MASK);
            this.pause(2000);
            robot.mouseMove(x,y); 
            ...
            System.out.println("[Info] element dragged successfully - " + elementXpath);
            return true;
        } catch (Exception e) {
            System.err.println("[Error] Failed to drag element by Xpath - " + e.getMessage());
            this.DriverExceptionDetail = e.getMessage();
     ...
     //Sibusiso Mnisi 
      public boolean MouseDragElementByXpathOffsetUsingRobot(String elementXpath, int x,int y) { 
        try {
            this.waitForElementByXpath(elementXpath);
            Robot robot = new Robot(); 
            this.pause(1500);
    ...
    //Sakhumzi Ncantswa
    public int getNumberOfSubElements(String mainElementXpath,String SubElementTagName)
    {
        List<WebElement> tr_collection = null;
        try
        {
           this.waitForElementByXpath(mainElementXpath);
           WebElement table_element = Driver.findElement(By.xpath(mainElementXpath));
           tr_collection = table_element.findElements(By.tagName(SubElementTagName));
    ...
    //Siwaphiwe Mbiko
    public void pressKey_ClickOnce(Keys keyToPress,String xpath1) {
        try {
            waitForElementByXpath(xpath1);
            Actions action = new Actions(Driver);
            action.sendKeys(keyToPress);
    ...
    //Sakhumzi Ncantswa
    public String GetElementWithNoLocationID(String DivXpath,int columnNumber)
    {
        WebElement table_element = Driver.findElement(By.xpath(DivXpath));
        List<WebElement> tr_collection = table_element.findElements(By.tagName("tr"));
        int row_num = 1, col_num = 0;
        ...
        //<editor-fold defaultstate="collapsed" desc="----------HTML Table Data----------">
        System.out.println("----------HTML Table Header Data----------");
        DataRow currentRow = new DataRow();
        try
        {
            for (int k = 3; k < tr_collection.size(); k++) 
            {
                //ctl00_cntMainBody_ReInsurance2007Cntrl_gvReinsurance
                List<WebElement> td_collection = tr_collection.get(k).findElements(By.tagName("td"));
                DataRow currentRow0 = new DataRow();
                ...
                if(!td_collection.isEmpty())
                {
                    CellXpath = "//table[@class='table table-scroll table-condensed table-list no-text-clip']/tbody/tr["+k+"]/td[3]/div//span";
                    WebElement Cell1 = Driver.findElement(By.xpath(CellXpath));
                    LocationName = Cell1.getText().trim();
                    CellXpath = "//table[@class='table table-scroll table-condensed table-list no-text-clip']/tbody/tr["+k+"]/td[" + (columnNumber-1) + "]/div//span";
                    WebElement Cell = Driver.findElement(By.xpath(CellXpath));
                    String parameters = Cell.getText().trim();
    ...
    //Andisiwe Peter
    public void pressControlKeyToSelectTwoElementsUsingXpath(String elementXpath1, String elementXpath2)
    {
        WebElement elementToRead1 = Driver.findElement(By.xpath(elementXpath1));
        WebElement elementToRead2 = Driver.findElement(By.xpath(elementXpath2));
        Actions actions = new Actions(Driver);
        actions.keyDown(Keys.CONTROL)
        .click(elementToRead1)
        .click(elementToRead2)
        .keyUp(Keys.CONTROL)
        .build()
        .perform();
    }
    ...
    //Sakhumzi Ncantswa
    public int getNumberOfSubElementsByXpath(String mainElementXpath,String SubElementXpath)
    {
        List<WebElement> tr_collection = null;
        try
        {
           this.waitForElementByXpath(mainElementXpath);
           WebElement table_element = Driver.findElement(By.xpath(mainElementXpath));
           tr_collection = table_element.findElements(By.xpath(SubElementXpath));
    ...
    //Shannon Scholtz
    public boolean MoveToElementUsingXpathRobot(String elementXpath, int x, int y) {
...
//          robot.mouseRelease(InputEvent.BUTTON1_MASK);
    ...
    public String switchToNewTAB()
    {
      try 
        ...
        catch (Exception e) 
        {
            ...
            this.DriverExceptionDetail = e.getMessage();
            return "Failed to switch to new tab - " + e.getMessage();
        }
    }
    
    //Siwaphiwe Mbiko
    public boolean clickAndHoldArrowElementByXpath(String elementXpath) {
        try {
            boolean flag = false;
            System.out.println("[Info]Performing click and hold for element - " + elementXpath);
            this.waitForElementByXpath(elementXpath);
    ...
    public String retrievePageTitle() 
    {
        ...
        try 
        {
            retrievedText = Driver.getTitle();
            System.out.println("[Info] Page title retrieved successfully");
            return retrievedText;
        } 
        catch (Exception e) {
            System.err.println("[Error] Failed to retrieve Page title" + e.getMessage());
            this.DriverExceptionDetail = e.getMessage();
            return retrievedText;
        }
    }
    ...
    //Andisiwe Peter
    public boolean zoomOutUsingMouseWheel(int x, int y, int wheelAmount){
        try{
            Robot robot = new Robot();
            robot.mouseMove(x, y);
            ...
            System.err.println("[Error] Failed to zoom out using mouse wheel - " + e.getMessage());
            this.DriverExceptionDetail = e.getMessage();
            return false;
        }
        return true;
    ...
    //Sboniso Mncwabe
    public boolean zoomOutUsingMouseWheelWithOutClick(int x, int y, int wheelAmount){
        try{
            Robot robot = new Robot();
            robot.mouseMove(x, y);
    ...
    //rwalker
    public String getElementTextByXpathException(String elementXpath) {
        try 
        {
            String retrievedText;
            this.waitForElementByXpath(elementXpath,30);
