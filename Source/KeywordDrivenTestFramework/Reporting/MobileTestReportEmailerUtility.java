 ...
 * @author fnell
 */
public class MobileTestReportEmailerUtility extends BaseClass {
    ...
    public MobileTestReportEmailerUtility(List<TestResult> _testResults/*, String inputFilePath*/) {
    ...
    public MobileTestReportEmailerUtility()
    {
    ...
    public String GenerateTestReport() {
        ...
        HtmlEmailBody.append("<h1 style=\"font-family:verdana;\">Automation Test Report - " + resolveScenarioName() + " On - Mobile Environment</h1>\n");
        HtmlEmailBody.append("<h3 style=\"font-family:verdana;\">Report date - " + dateTime + "</h2>\n");
        HtmlEmailBody.append("<h3 style=\"font-family:verdana;\">Mobile Platform :" +currentPlatform.name()+"</h2>\n");
